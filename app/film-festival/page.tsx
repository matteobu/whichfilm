...
const FilmFestivalList: React.FC = () => {
  return (
    <main className="bg-gradient-dark-gray-blue min-h-screen flex flex-col items-center justify-center text-white py-10">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold bg-clip-text text-white mb-6">
          Page in progress, like my life.{' '}
        </h1>
